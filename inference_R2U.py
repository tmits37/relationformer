...
if __name__ == "__main__":
    ...
    ckpt_path = f"/nas/tsgil/relationformer/work_dirs/R2U_Net_pretrain/runs/baseline_R2U_Net_pretrain_epoch8_10/models/{dir_name}.pth"
    show_dir = f'/nas/tsgil/gil/infer_R2U/exp2/{dir_name}'
